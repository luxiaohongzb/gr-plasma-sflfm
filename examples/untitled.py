...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.start_freq = start_freq = 1500000000.0
        self.samp_rate = samp_rate = 40000000.0
        self.n_pulse_cpi = n_pulse_cpi = 128
        self.end_freq = end_freq = 2000000000.0

        ##################################################
        # Blocks
        ##################################################
        self.plasma_usrp_radar_0 = plasma.usrp_radar('serial_no =8001093', samp_rate, samp_rate, 3.0e9, 3.0e9, 50, 50, 0.5, True, '', False, start_freq, end_freq, step, 0.5, 0.2)
