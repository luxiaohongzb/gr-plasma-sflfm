 ...
 */
 ...
 private:
     ...
     bool verbose;
     size_t n_delay;
     double hop_start_freq, hop_end_freq, hop_step, lo_stabilize_time, step_delay;
     std::atomic<bool> paused;
     std::atomic<double> resume_time;
     std::atomic<uint64_t> tx_burst_seq;
     uint64_t tx_burst_seq_sent;
     std::mutex d_mutex;
     std::condition_variable d_tx_done;
     std::atomic<bool> tx_inflight;
